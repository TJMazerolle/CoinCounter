...
training_imageset_folder_name = "Dice"    # Change this to the desired folder name in ImageSets/YAMLFormat
desired_model_name = "DiceDetectionModel" # Change this to the name you want to give to the produced model
